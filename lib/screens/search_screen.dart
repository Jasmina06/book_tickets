...
import 'package:real_project2/widgets/icon_text_widget.dart';
        ...
        children: [
          ...
          Text(
            ...
            style: Styles.headLineStyle1.copyWith(
              fontSize: AppLayout.getHeight(context, 35),
            ),
          ),
         ...
         AppTicketTabs(firstTab: "Airline Tickets",secondTab:"Hotels"),
          ...
          Gap(AppLayout.getHeight(context, 25)),  // Added gap for consistency
          Container(
            padding: EdgeInsets.symmetric(
                ...
                Stack(
                  ...
                  Container(
                    ...
                    height:AppLayout.getHeight( context , 210),
                      padding :EdgeInsets.symmetric(vertical:AppLayout.getHeight(context, 15),horizontal: AppLayout.getHeight(context, 15) ),
                    decoration:BoxDecoration(
                      borderRadius: BorderRadius.circular(AppLayout.getHeight(context, 18)),
